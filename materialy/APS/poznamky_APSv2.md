...
o	Funkčnost – správné chování funkcí systémů, jak je definování funkční specifikací
o	Výkon – zde systém není pomalý
•	Podle kompatibility:
...
•	Smoke test – rychlý a jednoduchý test, zjišťujeme, zda jsou všechny části implementovány
•	Sanity test – cílem je zjistit, zda navrhovaná funkce funguje zhruba podle očekávání
•	Regres test
...
•	Systémové testy – nejvyšší, cílem ověřit zde systém funguje jako celek
•	Akceptační test – realizovány na straně zákazníka. Ověřuje, že produkt splňuje očekávané funkce a kvalitu.
...
o	Vizualizace procesů
o	Standardizace jazyka a symbolů
o	BPMN – bussiness process model notation, UML
o	Analýza a identifikace problémů
o	Zlepšení a optimalizace
o	Komunikace a implementace
